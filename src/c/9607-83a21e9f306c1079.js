...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [9607],
  {
      ...
      let S = a.default.forwardRef(function (e, t) {
        ...
        let M = a.default.useContext(f.RouterContext),
          ...
          { href: F, as: X } = a.default.useMemo(() => {
            ...
            let [e, t] = (0, u.resolveHref)(M, s, !0);
            return { href: e, as: E ? (0, u.resolveHref)(M, E) : t || e };
          }, [M, s, E]),
        ...
        try {
          ...
          if ((0, l.isDynamicRoute)(e.pathname) && e.searchParams && r) {
            let r = (0, n.searchParamsToUrlQuery)(e.searchParams),
              { result: u, params: i } = (0, c.interpolateAs)(
                e.pathname,
                e.pathname,
                r
              );
    ...
    23719: (e, t, r) => {
      ...
      let n = r(20582)._(r(28274)).default.createContext(null);
    },
    94963: (e, t, r) => {
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (function (e, t) {
    ...
    70710: (e, t, r) => {
      ...
      function a(e, t, r) {
        let a = "",
          ...
          i = u.groups,
          s = (t !== e ? (0, n.getRouteMatcher)(u)(t) : "") || r;
        a = e;
        let l = Object.keys(i);
        return (
          l.every((e) => {
          ...
          parameterizedRoute: t
            .map((e) => {
              let t = o.INTERCEPTION_ROUTE_MARKERS.find((t) => e.startsWith(t)),
                u = e.match(i);
              if (t && u) {
                let { key: e, optional: o, repeat: i } = l(u[1]);
                return (
                  (r[e] = { pos: n++, repeat: i, optional: o }),
                  "/" + (0, a.escapeStringRegexp)(t) + "([^/]+?)"
                );
              }
              if (!u) return "/" + (0, a.escapeStringRegexp)(e);
              {
                let { key: e, repeat: t, optional: o } = l(u[1]);
                return (
